...
class _HomeState extends State<Home> with TickerProviderStateMixin<Home> {
  static const List<Destination> allDestinations = <Destination>[
    Destination(0, 'Teal', Icons.home_outlined, Icons.home_rounded, Colors.teal),
    Destination(1, 'Cyan', Icons.camera_alt_outlined, Icons.camera_alt_rounded, Colors.cyan),
    Destination(2, 'Orange', Icons.school_outlined, Icons.school_rounded, Colors.orange),
    Destination(3, 'Blue', Icons.person_outlined, Icons.person_rounded, Colors.blue),
  ];
  ...
  AnimationController buildFaderController() {
    final AnimationController controller = AnimationController(vsync: this, duration: const Duration(milliseconds: 500));
...
class ListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ButtonStyle buttonStyle = OutlinedButton.styleFrom(
      ...
      fixedSize: const Size.fromHeight(88),
          ...
          itemBuilder: (BuildContext context, int index) {
            return Padding(
              ...
              child: OutlinedButton(
                ...
                child: Text(
                  'Push /text [$index]',
                  style: TextStyle(color: Color.lerp(destination.color[200], Colors.black87, 1 - (index / itemCount))!),
                ),
              ),
            );
          },
